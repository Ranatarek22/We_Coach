...
class ViewController extends Controller
{
    public function index(){
        ...
        $subscription=SubscriptionType::all()->where("branchID",$branch->id);
        $days=unserialize($branch->days);
        return view("manager.branch.index",["branch"=>$branch,"subscription"=>$subscription,"days"=>$days]);
    }
